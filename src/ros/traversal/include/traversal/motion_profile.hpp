...
public:
	...
	profile() : linear_velocity(0), angular_velocity(0), max_velocity(150), cur_angle(0), tar_angle(0), distance(1), at_destination(false), m_path(std::vector<motion_node>()){}; //path(std::vector<point>()),
